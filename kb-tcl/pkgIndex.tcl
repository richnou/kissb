set ::kissDir $dir
package ifneeded kissb                      1.0 [list foreach f [concat [lsort [glob $dir/kiss/kiss.plugin*.kb]] [list $dir/globals.tcl] [list $dir/info.tcl] [glob -nocomplain $dir/*.conf.tcl] ] {source $f}]
